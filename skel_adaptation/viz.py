...
def pick_random_sample(args):
    ...
    # Load SMPL motion
    smpl_path = os.path.join(args.forward_data_root, split.replace('_train', ''), f"{selected}.npy")
    if not os.path.exists(smpl_path):
        raise FileNotFoundError(f"Missing SMPL file at {smpl_path}")
